...
//							movieFragment);
					...
					showTabFragment(movieFragment, fragmentTransaction);
...
//					fragmentTransaction.replace(R.id.fragment_container,
//							faqFragment);
					showTabFragment(faqFragment, fragmentTransaction);
...
//					fragmentTransaction.replace(R.id.fragment_container,
//							jrClubFragment);
					showTabFragment(jrClubFragment, fragmentTransaction);
...
//		appInfo.downloadInfo();
	...
	public void showTitle(String content){
		...
		if(content.equals("liveFragment")){
